...
public class OLhomeAdapter extends XRecyclerView.Adapter<OLhomeAdapter.MyViewHolder> {
    private final Activity mContext;
    private final ArrayList<HomeCategoryList> categoryList;

    public OLhomeAdapter(final Activity mContext, ArrayList<HomeCategoryList> category_list) {
